        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
                <div className="flex items-center gap-2 mb-4 justify-center md:justify-start">
                    ...
                    <span className="font-bold text-xl text-gray-100">Prisma Brasil</span>
                </div>
            ...
            <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                    <li><a href="#" className="hover:text-gray-100 transition-colors">Sobre Nós</a></li>
                    <li><a href="#" className="hover:text-gray-100 transition-colors">Termos de Uso</a></li>
                    <li><a href="#" className="hover:text-gray-100 transition-colors">Política de Privacidade</a></li>
                </ul>
            </div>
            
            <div>
                <h4 className="font-bold text-gray-100 mb-4">Contato</h4>
                <ul className="space-y-2 text-sm text-gray-400">
                    ...
                    <li className="flex items-center gap-2 justify-center md:justify-start">
                        <Instagram size={16} className="text-gray-100" />
